...
let idx = 0
let eightyArray = [80, 78, 76, 74, 72, 70, 68, 66, 64, 62, 60, 58, 56, 54, 52, 50, 48, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 70, 72, 74, 76, 78]
...
function draw() {
  ...
  //1st row of ellipses using for fuction to draw ellipses every
    ...
    pos_x = width/eightyArray[idx]*i;
    drawSliderEllipse();
		drawSliderEllipse2();
  }
	//commented out, had weird unintentional effect on sketch not sure what it caused it -- see first screenshot
//	idx++
//if (idx == (eightyArray.length - 1)) {
//	idx = 0
//}
...
//make function for sliding ellipse to represent color2 value
...
//make function for sliding ellipse to represent color1 value
function drawSliderEllipse2() {
	push();
	fill(color1);
	ellipse(((width/255)*color1), 15, 30)
	pop();
}
